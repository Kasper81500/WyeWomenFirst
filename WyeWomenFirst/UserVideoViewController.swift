...
class UserVideosController:UITableViewController
{
    var memberId :String = ""
            ...
            .responseJSON { response in
                ...
                if let value: AnyObject = response.result.value {
                    ...
                    if(results1 == "novideo")
                    {
                        ...
                        let alertController = UIAlertController(title: "User Video", message: "Sorry no Videos yet Please upload first", preferredStyle: .Alert)
