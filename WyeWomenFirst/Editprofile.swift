...
func displayMessage(message:String)
{
  ...
  func imagePickerController(picker: UIImagePickerController, didFinishPickingMediaWithInfo info: [String : AnyObject]) {
    ...
    //http://service.womenwomenfirst.com/service1.svc/UploadProfileImage/
 ...
 func URLSession(session: NSURLSession, task: NSURLSessionTask, needNewBodyStream completionHandler: (NSInputStream?) -> Void)
    ...
    
   {
    ...
    func sendData1(name:String,surname:String,email:String,country:String,county:String,district:String,city:String,terroritry:String,candidate:String,phone:String)
    {
      ...
      //  http://applehotelbooking.com/webapi/Service1.svc/Updatemember/1/Ajay/Sharma/Test@gmail.com/County/65/District2/City/terroritry/Candidate1
        
        
        
        
        //http://service.womenwomenfirst.com/Service1.svc/GetMember/1
        
        
        //http://service.womenwomenfirst.com/Service1.svc/Updatemember
        ...
        let url = NSURL(string:"http://applehotelbooking.com/webapi/Service1.svc/Updatemember/1/"+finalname+"/"+finalsurname+"/"+email+"/"+finalcounty+"/"+finalcountry+"/"+finaldistrict+"/"+finalcity+"/"+finalterritory+"/"+candidate+"/"+finalphone+"/PPS/PA")
        */
        
        
        
       /// print(url)
   //     var nsurlreq = NSMutableURLRequest(URL: NSURL(string: url)!, cachePolicy: NSURLRequestCachePolicy.ReturnCacheDataElseLoad, timeoutInterval: 100)
            ...
            .responseJSON { response in
                ...
                if let value: AnyObject = response.result.value {
                    ...
                    {
                        //self.displayMessage(String(results))
    ...
    func getList(memberid:String)
    {
       ...
       // http://service.womenwomenfirst.com/Service1.svc/GetMember/
